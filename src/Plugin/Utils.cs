    ...
    public partial class SharpTimer
    {
        ...
        private void LoadMapData(string mapName)
        {
            try
            {
                ...
                string[] bonusdataFileNames = new string[10];
                string[] bonusdataPaths = new string[10];

                foreach (string file in files){
                    if(file.Contains($"{currentMapName}_bonus1")){
                        totalBonuses[0] = 1;
                        bonusdataFileNames[0] = $"/SharpTimer/MapData/{currentMapName}_bonus1.json";
                        bonusdataPaths[0] = Path.Join(gameDir + "/csgo/cfg", bonusdataFileNames[0]);
                    }
                    else if(file.Contains($"{currentMapName}_bonus2")){
                        totalBonuses[1] = 2;
                        bonusdataFileNames[1] = $"/SharpTimer/MapData/{currentMapName}_bonus2.json";
                ...
                foreach (int bonus in totalBonuses){
                    ...
                    {                  
                    using JsonDocument? bonusJsonDocument = LoadJsonOnMainThread(bonusdataPaths[bonus-1]);
                    if (bonusJsonDocument != null)
                    {
                        ...
                        if (useTriggers == false && currentBonusStartC1[bonus] != null && currentBonusStartC2[bonus] != null && currentBonusEndC1[bonus] != null && currentBonusEndC2[bonus] != null)
                        {
