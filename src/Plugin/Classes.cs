...
public class EntityCache
{
    ...
    public void UpdateCache()
    {
        ...
        InfoTeleportDestinations = Utilities
            .FindAllEntitiesByDesignerName<CInfoTeleportDestination>("info_teleport_destination").ToList();
    }
}
...
public class PlayerTimerInfo
{
    ...
    public List<QAngle> Rotation { get; set; } = new();
    ...
    public List<ViewAngle> ViewAngles { get; set; } = new();
    public List<float> YawSpeed { get; set; } = new();
    public List<float> YawAccel { get; set; } = new();
    public List<double> AvgAccel { get; set; } = new();
    public double YawAccelPercent { get; set; }
    public List<double> YawAccelPercents { get; set; } = new();
    public List<bool> MoveLeft { get; set; } = new();
    public List<bool> MoveRight { get; set; } = new();
...
public class PlayerJumpStats
{
    ...
    public List<IFrame> jumpFrames { get; set; } = new();
    public List<IFrame> timerSyncFrames { get; set; } = new();
