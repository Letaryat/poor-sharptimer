...
public partial class SharpTimer
{
    ...
    public override string ModuleVersion => "0.3.1r";
    ...
    private readonly Dictionary<int, PlayerJumpStats> playerJumpStats = [];
    private readonly Dictionary<int, PlayerReplays> playerReplays = [];
    private readonly Dictionary<int, List<PlayerCheckpoint>> playerCheckpoints = [];
    ...
    private readonly Dictionary<uint, CCSPlayerController> specTargets = [];
    ...
    private readonly Dictionary<nint, int> cpTriggers = [];
    public int cpTriggerCount;
    private bool useCheckpointTriggers;
    public bool useCheckpointVerification = true;
    public bool useAnticheat = false;

    private readonly Dictionary<int, Vector?> bonusRespawnPoses = [];
    private readonly Dictionary<int, QAngle?> bonusRespawnAngs = [];
    ...
    private readonly Dictionary<nint, int> bonusCheckpointTriggers = [];
    private int bonusCheckpointTriggerCount;
    private bool useBonusCheckpointTriggers;
    ...
    private readonly Dictionary<nint, int> stageTriggers = [];
    private readonly Dictionary<int, Vector?> stageTriggerPoses = [];
    private readonly Dictionary<int, QAngle?> stageTriggerAngs = [];
    ...
    private bool rankEnabledInitialized;
    ...
    public string discordWebhookPFPUrl =
        "https://cdn.discordapp.com/icons/1196646791450472488/634963a8207fdb1b30bf909d31f05e57.webp";

    public string discordWebhookImageRepoURL =
        "https://raw.githubusercontent.com/Letaryat/poor-SharpTimerDiscordWebhookMapPics/main/images/";
    ...
    public string? remoteKZDataSource =
        "https://raw.githubusercontent.com/Letaryat/poor-SharpTimer/main/remote_data/kz_.json";
    ...
    public string? testerPersonalGifsSource =
        "https://raw.githubusercontent.com/Letaryat/poor-SharpTimer/main/remote_data/tester_bling.json";
    ...
    public static string UnrankedIcon =
        "https://raw.githubusercontent.com/Letaryat/poor-SharpTimer/main/remote_data/rank_icons/unranked.png";

    public List<RankData> rankDataList = new();
    ...
    private readonly Dictionary<string, WeaponSpeedStats> weaponSpeedLookup = new()
    {
